...
for pt in [100,200,500,1000]:
  ...
  np.savez_compressed("mixed{}pteta".format(pt),ptset=ptset,etaset=etaset,bdtset=bdtset,cnnset=cnnset,rnnset=rnnset,label=label)
  print(len(ptset))
  del train
  ...
  cnnset=np.array(cnnset)
  rnnset=np.array(rnnset)
  np.savez_compressed("mixed{}pt".format(pt),ptset=ptset,etaset=etaset,bdtset=bdtset,cnnset=cnnset,rnnset=rnnset,label=label)
  print(len(ptset))
