  ...
  for cut in ["nocut"]:
    ...
    for i in range(len(varss)):
      ...
      if("mult" in varss[i]):
        ...
        hists.append(rt.TH1F("zqhist{}".format(varss[i]),"zg/gg sj {}".format(varss[i]),int(ma/binh),0,int(ma)))
        hists.append(rt.TH1F("zghist{}".format(varss[i]),"zg/gg yj {}".format(varss[i]),int(ma/binh),0,int(ma)))
        hists.append(rt.TH1F("qqhist{}".format(varss[i]),"gg sj {}".format(varss[i]),int(ma/binh),0,int(ma)))
        hists.append(rt.TH1F("gghist{}".format(varss[i]),"gg yj {}".format(varss[i]),int(ma/binh),0,int(ma)))
      elif("eta" in varss[i]):
        hists.append(rt.TH1F("hist{}".format(varss[i]),"{}-{}".format(pt,varss[i]),int(100/binh),-2.4,2.4))
        hists.append(rt.TH1F("zqhist{}".format(varss[i]),"zg/gg sj {}".format(varss[i]),int(100/binh),-2.4,2.4))
        hists.append(rt.TH1F("zghist{}".format(varss[i]),"zg/gg yj {}".format(varss[i]),int(100/binh),-2.4,2.4))
        hists.append(rt.TH1F("qqhist{}".format(varss[i]),"gg sj {}".format(varss[i]),int(100/binh),-2.4,2.4))
        hists.append(rt.TH1F("gghist{}".format(varss[i]),"gg yj {}".format(varss[i]),int(100/binh),-2.4,2.4))
      else:
        hists.append(rt.TH1F("hist{}".format(varss[i]),"{}-{}".format(pt,varss[i]),int(100/binh),mi,ma))
        hists.append(rt.TH1F("zqhist{}".format(varss[i]),"zg/gg sj {}".format(varss[i]),int(100/binh),mi,ma))
        hists.append(rt.TH1F("zghist{}".format(varss[i]),"zg/gg yj {}".format(varss[i]),int(100/binh),mi,ma))
        hists.append(rt.TH1F("qqhist{}".format(varss[i]),"gg sj {}".format(varss[i]),int(100/binh),mi,ma))
        hists.append(rt.TH1F("gghist{}".format(varss[i]),"gg yj {}".format(varss[i]),int(100/binh),mi,ma))
      ...
      rt.gPad.BuildLegend()
    canv.SaveAs("bdtvars/sjnocr{}_{}.png".format(pt,cut))
    zqdata.Close()
    zgdata.Close()
    qqdata.Close()
    ggdata.Close()
