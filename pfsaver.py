...
np.savez_compressed("/home/yulee/keras/pf{}".format(pt),ptset=ptset,etaset=etaset,phiset=phiset,pidset=pidset,seqset=seqset,imgset=imgset,bdtset=bdtset,labelset=labelset,eveset=eveset,njset=njset,pairlist=pairlist)
print("pf{}".format(pt))
label1=[]
label2=[]
Y=eveset
