...
test2.reset()
test3.reset()
np.savez_compressed('get{}'.format(args.pt),
                    gjet2=test2.gjetset,gpt2=test2.gptset,geta2=test2.getaset,
                    qjet2=test2.qjetset,qpt2=test2.qptset,qeta2=test2.qetaset,
                    gjet3=test3.gjetset,gpt3=test3.gptset,geta3=test3.getaset,
                    qjet3=test3.qjetset,qpt3=test3.qptset,qeta3=test3.qetaset)
