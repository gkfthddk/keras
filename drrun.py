...
traindata,valdata,testdata=prepare_data(data_path,data_form="pixel",batch_size=batch_size,num_channel=channel)
...
testchain=[rt.TChain("event"),rt.TChain("event")]
for i in range(400,500): 
  testchain[0].Add("/pad/yulee/geant4/tester/analysis/fast/uJet50GeV_fastsim_{}.root".format(i)) 
  testchain[1].Add("/pad/yulee/geant4/tester/analysis/fast/gJet50GeV_fastsim_{}.root".format(i))
testdata=DataGenerator(testchain,data_form="pixel",batch_size=batch_size)
...
f=open("/home/yulee/keras/drbox/{}.auc".format(args.memo),"a")
if(channel==-1):
