...
dqfile=[eval(i) for i in open("{}/v1t3ptq.dat".format(savename)).readlines()]
zqfile=[eval(i) for i in open("{}/v1t2ptq.dat".format(savename)).readlines()]
dgfile=[eval(i) for i in open("{}/v1t3ptg.dat".format(savename)).readlines()]
zgfile=[eval(i) for i in open("{}/v1t2ptg.dat".format(savename)).readlines()]
f=rt.TFile("{}/ptget.root".format(savename),"recreate")
