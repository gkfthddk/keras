...
for bpt in [100,200,500,1000]:
  ...
  names=["asuqqbdt{}pt".format(pt),"asuzqbdt{}pt".format(pt),"asuqqrnn{}ptonly21".format(pt),"asuzqrnn{}ptonly21".format(pt),"asuqqcnn{}ptonly".format(pt),"asuzqcnn{}ptonly".format(pt)]
  ...
  plt.grid(alpha=0.6)
  plt.axis((0,1,0,1))
  plt.savefig("plots/asupurerocpt{}.pdf".format(pt),bbox_inches='tight',pad_inches=0.5,dpi=300)
