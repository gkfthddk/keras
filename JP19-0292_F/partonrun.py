...
if(args.isz==0):
  ...
  train=wkiter([tgdata,tgdata],batch_size=batch_size,end=1.,istrain=1,rc=rc,onehot=onehot,eta=args.eta,etabin=args.etabin,pt=args.pt,ptmin=args.ptmin,ptmax=args.ptmax,unscale=args.unscale,normb=args.normb)
