...
tjdata="/home/yulee/keras/genroot/pf_pp_jj_{0}.root".format(pt)
etabin=2.4
ptmin=0
ptmax=2
print(pt,tjdata)
#train=jetiter([tjdata],batch_size=128,istrain=1,rc="r",etabin=etabin,pt=pt,ptmin=ptmin,ptmax=ptmax,unscale=1,end=1)
train=jetiter([tjdata],batch_size=128,istrain=1,rc="rc",etabin=etabin,pt=pt,ptmin=ptmin,ptmax=ptmax,unscale=1,end=1,channel=64)
ptset=train.ptset
etaset=train.etaset
pidset=train.pidset
bdtset=train.bdtset
...
np.savez_compressed("/home/yulee/keras/jj25{}".format(pt),ptset=ptset,etaset=etaset,pidset=pidset,seqset=seqset,imgset=imgset,bdtset=bdtset,labelset=labelset,eveset=eveset,pairlist=pairlist)
print("jj{}".format(pt))
label1=[]
label2=[]
Y=eveset
