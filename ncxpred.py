...
#vzqdata="jets/mg5_pp_zq_nocr.root".format(args.pt,int(args.pt*1.1))
#vzgdata="jets/mg5_pp_zg_nocr.root".format(args.pt,int(args.pt*1.1))
#vqqdata="jets/mg5_pp_qq_nocr.root".format(args.pt,int(args.pt*1.1))
#vggdata="jets/mg5_pp_gg_nocr.root".format(args.pt,int(args.pt*1.1))
vzjdata="jets/30mg5_pp_zj_pt_{0}_{1}30.root".format(args.pt,int(args.pt*1.1))
vjjdata="jets/30mg5_pp_jj_pt_{0}_{1}30.root".format(args.pt,int(args.pt*1.1))
vzqdata="jets/30mg5_pp_zq_pt_{0}_{1}30.root".format(args.pt,int(args.pt*1.1))
vzgdata="jets/30mg5_pp_zg_pt_{0}_{1}30.root".format(args.pt,int(args.pt*1.1))
vqqdata="jets/30mg5_pp_qq_pt_{0}_{1}30.root".format(args.pt,int(args.pt*1.1))
vggdata="jets/30mg5_pp_gg_pt_{0}_{1}30.root".format(args.pt,int(args.pt*1.1))
...
test2=wkiter([vzqdata,vzgdata],batch_size=batch_size,begin=0.,end=args.end*0.6,rc=rc,onehot=onehot,channel=args.channel,order=args.order,eta=0,etabin=2.4)
test3=wkiter([vqqdata,vggdata],batch_size=batch_size,begin=0.,end=args.end*0.6,rc=rc,onehot=onehot,channel=args.channel,order=args.order,eta=0,etabin=2.4)
...
f=rt.TFile("xgb/30nocr{}get.root".format(args.save),"recreate")
