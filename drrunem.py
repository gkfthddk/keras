...
'''
#python3 drrunen.py --gpu 7 --epochs 50 --pt 20 --opt adam --save drepen1p --channel 4 --batch_size 64 --dform pixel --pix 56 --pool 1
#python3 drrunem.py --gpu 6 --epochs 50 --pt 20 --opt adam --save drg2p20fimg2p --channel 4 --batch_size 64 --dform pixel --pix 56 --pool 2
#python3 drrunem.py --gpu 5 --epochs 50 --pt 20 --opt adam --save dre2g20fimg1p --channel 4 --batch_size 64 --dform pixel --pix 56 --pool 1
#python3 -i drrunem.py --gpu 2 --epochs 10 --pt 20 --opt adam --save drep20pnt --channel 4 --batch_size 64 --dform point
...
if("gp" in args.memo):
  data_path=["/pad/yulee/geant4/tester/analysis/ga{}.root".format(args.pt),
    "/pad/yulee/geant4/tester/analysis/pi{}.root".format(args.pt)]
if(args.dform=="point"):
  traindata=np.load(os.path.abspath(os.getcwd())+"/npzs/drpointep{}.npz".format(args.pt)) 
  #traindata=np.load(os.path.abspath(os.getcwd())+"/npzs/drpointegp{}.npz".format(args.pt)) 
elif(args.dform=="pixel"):
  traindata=np.load(os.path.abspath(os.getcwd())+"/npzs/dregp{}fimg.npz".format(args.pt)) 
else:
...
if(args.dform=="point"):
  ...
  siglabel=len(traindata["el"])*[[1.,0]]
  baklabel=len(traindata["el"])*[[0.,1.]]
  if("ep" in args.save):
