...
plt.grid(alpha=0.6)
plt.axis((0,1,0,1))
plt.savefig("plots/roc{}.pdf".format(pt),bbox_inches='tight',pad_inches=0.5,dpi=300)
plt.savefig("plots/roc{}.png".format(pt),bbox_inches='tight',pad_inches=0.5,dpi=300)
#plt.show()
