...
def get_symbol(input_shape1,input_shape2,weights_path=None):
    ...
    # group 3
    padd3_1=ZeroPadding2D((1,0))(pool2)
    conv3_1=Conv2D(256, (3, 1), activation='relu')(padd3_1)
    padd3_2=ZeroPadding2D((0,1))(conv3_1)
    conv3_2=Conv2D(256, (1, 3), activation='relu')(padd3_2)
    padd3_3=ZeroPadding2D((1,0))(conv3_2)
    conv3_3=Conv2D(256, (3, 1), activation='relu')(padd3_3)
    padd3_4=ZeroPadding2D((0,1))(conv3_3)
    conv3_4=Conv2D(256, (1, 3), activation='relu')(padd3_4)
    padd3_5=ZeroPadding2D((1,0))(conv3_4)
    conv3_5=Conv2D(256, (3, 1), activation='relu')(padd3_4)
    padd3_6=ZeroPadding2D((0,1))(conv3_5)
    conv3_6=Conv2D(256, (1, 3), activation='relu')(padd3_5)
    ...
    rnn=LSTM(units=128,dropout=0.2,return_sequences=True)(input2)
    flatr=Flatten()(rnn)
