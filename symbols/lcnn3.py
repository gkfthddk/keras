...
def get_symbol(input_shape,weights_path=None):
    ...
    conv1_1=LocallyConnected2D(64, (3, 3), activation='relu')(padd1_1)
    pool1=MaxPooling2D((2,2), strides=(2,2))(conv1_1)
    # group 2
    padd2_1=ZeroPadding2D((1,1))(pool1)
    conv2_1=LocallyConnected2D(128, (3, 3), activation='relu')(padd2_1)
    padd2_2=ZeroPadding2D((1,1))(conv2_1)
    conv2_2=LocallyConnected2D(128, (3, 3), activation='relu')(padd2_2)
