...
train=wkiter(["/scratch/yjdata/ppzj100__img.root","/scratch/yjdata/ppjj100__img.root"],batch_size=batch_size,begin=0.,end=args.end*5./5.,istrain=1,rc=rc)
valid=wkiter(["/scratch/yjdata/quark100_img.root","/scratch/yjdata/gluon100_img.root"],batch_size=batch_size,begin=4./5.,end=4./5.+args.end*1./5.,rc=rc)
