    ...
    while self.endfile==0:
      ...
      for i in range(self.batch_size):
        ...
        if("r" in self.rc):
          ...
          dauset.append([[dau_pt[dausort[19-i]], dau_deta[dausort[19-i]], dau_dphi[dausort[19-i]], dau_charge[dausort[19-i]]] if len(dau_pt)>19-i else [0.,0.,0.,0.] for i in range(20)])
        if(len(dau_pt)==0):
          print self.a
          print "@@@@@@@@@@@@@@"
          print self.a
